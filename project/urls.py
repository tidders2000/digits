...
urlpatterns = [
    ...
    path('password-reset/', users_views.change_password, name='password_reset'),
    path('password-reset/done/',authentication_views.PasswordResetDoneView.as_view(), name='password_reset_done'),
